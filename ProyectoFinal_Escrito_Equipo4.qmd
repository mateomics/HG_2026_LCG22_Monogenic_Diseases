...
> Tabla 2. Casos de estudio seleccionados para análisis funcional detallado, con su respectiva información genómica y clasificación de impacto funcional.
...
```{r Plot distribución por impacto funcional, eval = false}
#| label: fig:impact
...
```{r Plot top efectos moleculares, eval = false}
#| label: fig:effects
