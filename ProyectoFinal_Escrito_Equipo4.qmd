...
![](data/images/tabla_1_equivalencias.png){width=60%}
...
::: {#fig-impact fig-align="center"}

![](data/images/fig_2_3_impact_molecular_function.png){width=100%}

Características de las variantes patogénicas mendelianas únicas obtenidas: A) Distribución de variantes mendelianas patogénicas únicas según su impacto funcional predicho por SnpEff. B) Top 10 efectos moleculares más frecuentes entre las variantes mendelianas patogénicas únicas y sus porcentajes asociados según la anotación funcional de SnpEff. Se reportan tanto conteos absolutos como porcentajes.

:::

Por otro lado, se observa que la gran mayoría de las variantes mendelianas patogénicas únicas (82.0%) se clasifican con un impacto funcional `HIGH`, lo que sugiere que tienen una alta probabilidad de afectar severamente la función proteica. Un porcentaje considerable (16.0%) se clasificó como `MODERATE`, mientras que las categorías `LOW` y `MODIFIER` representaron una proporción menor.
...
De esta manera, la distribución observada no solo describe la localización genómica de las variantes, sino que orienta la interpretación de sus posibles consecuencias funcionales. Dado que los efectos más frecuentes corresponden a variantes *frameshift*, de pérdida de función, *missense* y alteraciones del *splicing*, se seleccionaron de forma determinista genes representativos de cada mecanismo para analizarlos con mayor detalle:

::: {#tbl-regiones tbl-pos="H"}
![](data/images/tabla_2_casos.png){width=80%}
